...
const App = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                const response = await axios.get('https://assignment-2-ip8z.onrender.com/questions');
    ...
    useEffect(() => {
        const fetchQuizzes = async () => {
            try {
                const response = await axios.get('https://assignment-2-ip8z.onrender.com/quizzes');
    ...
    const handleUpdateQuestion = async (updatedQuestion) => {
        try {
            await axios.put(`https://assignment-2-ip8z.onrender.com/questions/${updatedQuestion._id}`, updatedQuestion);
